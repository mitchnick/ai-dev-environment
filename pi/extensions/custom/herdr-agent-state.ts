...
// Herdr 0.8 can retain a higher sequence after integration reinstalls.
// Keep reports monotonic across the legacy sequence range while remaining below MAX_SAFE_INTEGER.
let reportSeq = 7_000_000_000_000_000 + Date.now() * 1000;
